...
STRESS_START = "2008-06-01" 
END_DATE = "2009-03-31"    
RISK_FREE_RATE = 0.03 / 252 
LAMBDA = 20

# download data or load data.stv file
...
# Benchmarks
# ==========================================
benchmark_returns = test_returns_lin.mean(axis=1) # Equal Weight
# linear returns for benchmark
test_market_log = market_data["daily"].loc[STRESS_START:]
test_market_lin = np.exp(test_market_log) - 1

# ==========================================
# Graph of cumulative returns returns
# ==========================================
...
plt.plot((1 + test_market_lin).cumprod().index, (1 + test_market_lin).cumprod(), label="S&P 500 Index", color="black", linestyle=":", alpha=0.8)

plt.title("Stress Test: Financial Crisis")
plt.legend()
...
plt.title("Correlation matrix of Out-of-Sample returns (Financial Crisis)", fontsize=14, pad=20)
plt.tight_layout()
plt.show()
